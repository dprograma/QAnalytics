...
fonts = [
    {
        "name": "Dragz",
        "dragz_regular": fonts_path + "62Dragz-vmAp9.otf"
    },
    {
        "name": "Acquire",
        "acquire_light": fonts_path + "AquireLight-YzE0o.otf",
        "acquire_bold": fonts_path + "AquireBold-8Ma60.otf",
        "acquire_bw": fonts_path + "Aquire-BW0ox.otf",
    },
    {
        "name": "Roboto",
